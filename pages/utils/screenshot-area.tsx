...
import { useContainerQuery } from "@cloudscape-design/components/internal/hooks/container-queries";
...
export default function ScreenshotArea({
  ...
  const [documentHeight, ref] = useContainerQuery(
    ...
    >
      {documentHeight && documentHeight > MAX_PAGE_HEIGHT && (
        <p style={{ color: colorTextStatusError }}>
          Warning: this page has height {documentHeight}px which is above the
          limit {MAX_PAGE_HEIGHT}. Taking a screenshot of this page may not
